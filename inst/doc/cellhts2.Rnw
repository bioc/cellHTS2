...
\begin{figure}[tp]
\begin{center}
\includegraphics[width=324px,height=324px]{cellhts2-configurationplot.png}
...
\Rfunction{scores2calls}, as shown in Figure~\ref{cellhts2-callvalues.png}.
%
...
plot(Data(xsc), Data(y), col="blue", pch=".",
     ...
     main=expression(1/(1+e^{-lambda *(z-z[0])})))
@ 
\myincfig{cellhts2-callvalues.png}{180px}{A sigmoidal transformation that can be used for obtaining call values.}
%
...
%------------------------------------------------------------
\myincfig{cellhts2-transfplots.png}{324px}{Comparison
