...
\begin{figure}[tp]
\begin{center}
\includegraphics[width=0.9\textwidth]{cellhts2Complete-configurationplot}
...
\Rfunction{scores2calls}, as shown in Figure~\ref{cellhts2Complete-callvalues}.
%
...
@ 
\myincfig{cellhts2Complete-callvalues}{0.5\textwidth}{A sigmoidal transformation that
