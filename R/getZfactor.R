...
## ---------------------------------------------------------------------------
# LPB, August 2007
# Auxiliary function to be called from 'writeReport' (similar to 'getZfactor' function, but performs less steps)
## ---------------------------------------------------------------------------
internalGetZfactor <- function(x, allControls, twoWay, namePos) {
